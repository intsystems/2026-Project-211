...
|  | A Geometric View of Data Complexity: Efficient Local Intrinsic Dimension Estimation with Diffusion Models | 2024 | Hamidreza Kamkari, Brendan Leigh Ross, Rasa Hosseinzadeh, Jesse C. Cresswell, Gabriel Loaiza-Ganem | [arXiv:2406.03537](https://arxiv.org/abs/2406.03537) | TODO | High-dimensional data often lies on low-dimensional structures, and estimating the local intrinsic dimension (LID) of data points is useful for detecting outliers and AI-generated text. LID indicates a datum's complexity based on its local factors of variation. Current LID estimation methods leveraging generative models are often inaccurate or computationally expensive. This paper introduces FLIPD, a new estimator that leverages diffusion models to calculate LID efficiently. The method outperforms existing baselines on benchmarks and is orders of magnitude faster. Applied to real images, FLIPD provides a useful complexity measure that aligns well with human perception and compression rates. |

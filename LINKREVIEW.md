...
|  | Your diffusion model secretly knows the dimension of the data manifold | 2023 | Jan Stanczuk, Georgios Batzolis, Teo Deveney, Carola-Bibiane Schönlieb | [arXiv:2212.12611](https://arxiv.org/abs/2212.12611) | TODO |A novel framework estimates intrinsic data manifold dimension by proving that a diffusion model's score function points toward the manifold at low noise levels, enabling tangent space dimension estimation and outperforming established statistical methods. |
|  | Estimating the effective dimension of large biological datasets using fisher separability analysis | 2019 | Luca Albergante, Jonathan Bac, and Andrei Zinovyev | [arXiv:1901.06328](https://arxiv.org/abs/1901.06328) | TODO | A new intrinsic dimensionality estimator based on analyzing data point separability is tested, showing competitive performance with state-of-the-art methods and robustness to noise, even when the manifold assumption is violated. |
|  | Dimensionality-aware outlier detection. | 2024 | Alastair Anderberg, James Bailey, Ricardo JGB Campello, Michael E Houle, Henrique O Marques, Miloš Radovanovic, and Arthur Zimek. | [arXiv:2401.05453](https://arxiv.org/abs/2401.05453) | TODO | DAO is a nonparametric outlier detection method that incorporates local intrinsic dimensionality estimates to account for data variations, significantly outperforming LOF, Simplified LOF, and kNN across extensive synthetic and real datasets. |
|  | Reverse-time diffusion equation models | 1982 | Brian DO Anderson | [paper](https://www.sciencedirect.com/science/article/pii/0304414982900515) | TODO | TODO |
...
|  | Deep generative models through the lens of the manifold hypothesis: A survey and new connections. | 2024 | Gabriel Loaiza-Ganem, Brendan Leigh Ross, Rasa Hosseinzadeh, Anthony L Caterini, and Jesse C Cresswell.  | [arXiv:2404.02954](https://arxiv.org/abs/2404.02954) | TODO | TODO |
|  | Estimating the intrinsic dimension of data with a fractal-based method | 2022 | F. Camastra and A. Vinciarelli. | [paper](https://www.dcs.gla.ac.uk/~vincia/papers/intrinsicdimension.pdf) | TODO | TODO |
|  | Intrinsic dimension estimation of data by principal component analysis.  | 2010 | Mingyu Fan, Nannan Gu, Hong Qiao, and Bo Zhang.  | [arXiv:1002.2050](https://arxiv.org/abs/1002.2050) | TODO | TODO |
|  | An algorithm for finding intrinsic dimensionality of data. | 1971 | K. Fukunaga and D.R. Olsen. | https://ieeexplore.ieee.org/document/1671801/ | TODO | TODO |
